...
## Corpus Check
- 309 files · ~135,355 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2016 nodes · 2128 edges · 293 communities (178 shown, 115 thin omitted)
...
## Communities (293 total, 115 thin omitted)
...
Cohesion: 0.27
Nodes (4): MOCK_PASSWORD_RESET_CODE, PASSWORD_RESET_CODE_LENGTH, PASSWORD_RESET_MIN_LENGTH, PASSWORD_RESET_TTL_MS
...
Cohesion: 0.67
Nodes (3): mapPocketBaseError(), PB_MESSAGE_MAP, withPbError()
...
Cohesion: 0.83
Nodes (3): assertAssignmentCreate(), assertAssignmentUpdate(), relId()
...
Cohesion: 0.80
Nodes (4): assertProgressCreate(), assertProgressUpdate(), relId(), teacherHasStudent()
...
Cohesion: 0.53
Nodes (4): assertNotificationCreate(), assertNotificationPreferencesCreate(), assertNotificationPreferencesUpdate(), relId()
...
## Knowledge Gaps
- **767 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+762 more)
